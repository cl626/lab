...
#
# Generated by export_simulation on Tue Apr 26 17:54:58 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './single_data_mem.sh' script.

./single_data_mem.sh -reset_run
...
./single_data_mem.sh -noclean_files

For more information on the script, please type './single_data_mem.sh -help'.
