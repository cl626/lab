...
# test 10 command
black:
auipc a0,0xffffe	#test auipc
addi x1,x0,1
sw x1, 0(a0)		#test sw
sw x1,0x408(x0)
light:		
addi t0,x0,4	#jal 位置+test addi
sw t0, 0(a0)
sw x1,0x408(x0)
...
blt t4,t3,testblt #test blt						
addi t4,x0,2
addi t5,x0,2
testblt:
addi t4,x0,2	#testblt位置
addi t5,x0,2
beq t4,t5,testbeq #test beq ;
