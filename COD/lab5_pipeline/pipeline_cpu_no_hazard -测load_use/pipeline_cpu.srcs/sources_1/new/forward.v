...
/*always@(posedge clk_cpu)    begin
        begin   if(ex_mem_regwrite&&rdm==ir[19:15])    afwd<=1;
        else  if(mem_wb_regwrite&&rdw==ir[19:15])      afwd<=2;
        else  afwd<=0;  end   
        begin   if(ir[6:0]==7'b0110011|ir[6:0]==7'b1100011|ir[6:0]==7'b0100011) //add/sub/beq/sw   
        if(ex_mem_regwrite&&rdm==ir[24:20])     bfwd<=1;   
        else if(mem_wb_regwrite&&rdw==ir[24:20])   bfwd<=2; 
        else bfwd<=0;   end
    end */
always@(posedge clk_cpu)    begin
        ...
        begin   if(ir[6:0]==7'b0110011|ir[6:0]==7'b1100011|ir[6:0]==7'b0100011) //add/sub/beq/sw,有第二个操作数
